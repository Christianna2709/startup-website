      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => (
            ...
            >
              <Card className="p-6 h-full flex flex-col group transition-all hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.05)] border-slate-100">
                <div className={`h-12 w-12 rounded-full ${value.iconBg} flex items-center justify-center mb-4 transition-transform group-hover:scale-110`}>
                  {value.icon}
                </div>
