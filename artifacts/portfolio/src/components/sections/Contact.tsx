          ...
          <Card className="p-8 md:p-10 border-l-4 border-primary">
            {isSuccess ? (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-2 z-10">Message Sent!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      type="text" 
                      required
                      className="w-full px-4 py-3 border border-input rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all shadow-sm"
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-input rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all shadow-sm resize-none"
